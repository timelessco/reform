...
(() => {
  var U = () => {
    ...
    g = (t, e) => {
      ...
      if (
        ...
        n.set("transparent", "true"),
        n.set("transparentBackground", "false"),
        n.set("hideTitle", e.hideTitle ? "true" : "false"),
        n.set("alignLeft", e.alignLeft ? "true" : "false"),
        n.set("dynamicHeight", "false"),
        n.set("dynamicWidth", "false"),
        e.hiddenFields)
      )
        for (let [a, r] of Object.entries(e.hiddenFields)) n.set(a, r);
      return (
        new URLSearchParams(window.location.search).forEach((a, r) => {
          n.has(r) || n.set(r, a);
        }),
  ...
  var y = (t, e, o) => {
      ...
      ((i.rel = t),
        (i.href = e),
        o !== void 0 && (i.crossOrigin = o),
        document.head.appendChild(i));
    },
    C = (t) => {
      t !== window.location.origin && (y("preconnect", t, "anonymous"), y("dns-prefetch", t));
    },
    D = (t) => {
    ...
    k = (t, e) => {
      let o = !1,
        ...
        i = { once: !0, passive: !0 };
      (t.addEventListener("pointerenter", n, i),
        t.addEventListener("focus", n, i),
  ...
  var z = /^[a-zA-Z0-9_-]{1,128}$/,
    ...
    X = (t) => {
      let e = t.dataset || {},
        o = e.formId && z.test(e.formId) ? e.formId : "";
      if (!o) return null;
      let n = Object.create(null);
      for (let [r, s] of Object.entries(e)) !G.has(r) && typeof s == "string" && (n[r] = s);
      let i = e.position;
      return {
        formId: o,
    ...
    I = () => {
      let t = document.createElementNS(x, "svg");
      ...
      let e = document.createElementNS(x, "path");
      (e.setAttribute("d", "M14 2H6a2 2 0 0 0-2 2v16a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2V8z"),
        t.appendChild(e));
      let o = document.createElementNS(x, "polyline");
      return (o.setAttribute("points", "14 2 14 8 20 8"), t.appendChild(o), t);
    },
    m = (t, e) => {
    ...
    O = (t, e, o) => {
      if (o && /^(https?:\/\/|\/)/.test(o)) {
        ...
        ((i.className = "bf-bubble__icon"), (i.src = o), (i.alt = ""), m(t, i));
        return;
      }
      if (o && V.test(o)) {
        let i = document.createElement("span");
        ((i.className = "bf-bubble__emoji"), (i.textContent = o), m(t, i));
        return;
      }
      ...
      (m(t, I()),
        fetch(`${e}/api/icons/${o}.svg`)
          .then((i) => (i.ok ? i.text() : null))
          .then((i) => {
            if (!i) return;
            let r = new DOMParser().parseFromString(i, "image/svg+xml").documentElement;
            !r ||
              r.tagName.toLowerCase() !== "svg" ||
              (r.setAttribute("class", "bf-bubble__icon"), m(t, document.importNode(r, !0)));
          })
          .catch(() => {}));
    },
    K = (t, e, o) => {
    ...
    H = (t) => {
      ...
      (k(i, () => T(r)),
        q(n, o.formId).then((s) => {
          s && (s.title && i.setAttribute("aria-label", s.title), s.icon && O(i, n, s.icon));
        }),
        i.addEventListener("click", () => {
          (i.classList.add("bf-bubble--hidden"),
            t(o.formId, {
              position: o.position,
              width: o.width,
              hideTitle: o.hideTitle,
              ...
              hiddenFields: o.hiddenFields,
              onClose: () => {
                i.classList.remove("bf-bubble--hidden");
              },
            }));
        }));
    };
  ...
  var j = (t, e, o) => {
      ...
      ((l.className = `bf-popup bf-popup--${n ? "center" : a}`),
        Object.assign(l.style, { width: `${r}px`, maxHeight: "600px" }));
      ...
      return (
        e.emoji?.text &&
          ...
          (p.className = `bf-emoji ${Z(e.emoji.animation)}`),
        ...
        { overlay: s, popup: l, iframeContainer: d, closeBtn: c, loadingEl: f, emojiEl: p }
      );
    },
    M = (t) => {
...
`,
    _ = () => {
      ...
      ((t.id = "bf-popup-styles"), (t.textContent = Q), document.head.appendChild(t));
    };
  var ee = (t) => {
      let e = {},
        o = t.dataset.layout;
      ...
      let a = t.dataset.emojiText,
        r = t.dataset.emojiAnimation;
      a && (e.emoji = { text: a, animation: r || "none" });
    ...
    v = (t) => {
      ...
      let a = e.get("width");
      a && (n.width = parseInt(a, 10));
      let r = e.get("emoji-text"),
        s = e.get("emoji-animation");
      r && (n.emoji = { text: r, animation: s || "none" });
    ...
    R = (t) => {
      document.addEventListener("click", (e) => {
        ...
        if (i?.href?.includes("form-open=")) {
          ...
          if (a !== -1) {
            let r = i.href.substring(a),
              { formId: s, options: l } = v(r);
            s && t(s, l);
          }
        }
      });
  ...
  var b = new Map(),
    ...
    h = (t) => {
      let e = b.get(t);
      if (e && (L(e.iframe), e.overlay && M(e.overlay), b.delete(t), e.options.onClose))
        try {
          e.options.onClose();
        } catch (o) {
      ...
      if (o)
        switch (e.event) {
          case "Reform.FormLoaded":
            break;
          case "Reform.Resize":
            typeof e.height == "number" && (E(o.iframe, e.height), P(o.container, e.height));
            break;
    ...
    B = () => {
      (_(), R(u), S(u), N(u), window.addEventListener("message", te), H(u));
    };
  window.Reform = { openPopup: u, closePopup: h };
