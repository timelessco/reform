...
- **Generation Tiers**:
  - _Preview_: Uses `generate-preview-schema.ts` for real-time editor validation.
  - _Production_: Uses `generate-zod-schema.ts` for final form logic and code export.
