                ...
                <div className="flex flex-col items-center justify-center py-20 px-4 text-center space-y-8 bg-muted/20 border-2 border-dashed rounded-3xl animate-in fade-in zoom-in duration-500">
                    ...
                    <div className="space-y-3 max-w-md">
                        ...
                        <p className="text-muted-foreground leading-relaxed">
                            Your form is currently in <Badge variant="secondary" className="px-1.5 py-0">draft</Badge>.
                            Publish it to get a shareable link and start collecting responses.
                        </p>
                    </div>
                    <Button
                        size="lg"
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-12 animate-in fade-in slide-in-from-bottom-4 duration-500">
                        <div className="space-y-6">
                            <div className="space-y-2">
                                <div className="flex items-center gap-2">
                                    ...
                                    <Badge variant="outline" className="text-[10px] bg-green-50 text-green-700 border-green-200 uppercase font-bold tracking-wider">Live</Badge>
                                </div>
                                <p className="text-sm text-muted-foreground leading-relaxed">
                                    Your form is published and ready to be shared! Copy
                                    this link to share it on social media, messaging apps, or via email.
                                </p>
                            </div>

                            <div className="flex gap-2 group">
                                <Input value={shareUrl} readOnly className="h-11 bg-muted/30 focus-visible:ring-primary border-transparent focus:border-primary transition-all pr-4" />
                                <Button onClick={handleCopy} className="h-11 px-6 gap-2 shrink-0 shadow-lg shadow-primary/10 hover:shadow-primary/20 transition-all">
                        ...
                        <div className="space-y-4">
                            <div className="flex items-center justify-between">
                                ...
                                <Button variant="ghost" size="sm" className="h-7 text-blue-600 text-xs gap-1.5 px-2 hover:bg-blue-50">
                            ...
                            <div className="border rounded-2xl p-5 bg-background shadow-sm space-y-3 max-w-sm mx-auto md:mx-0 group hover:shadow-md transition-shadow ring-1 ring-black/5">
                                <div className="flex items-center gap-2 mb-3">
                                    ...
                                    <span className="text-[11px] font-semibold text-muted-foreground">Better Forms</span>
                                </div>

                                <h4 className="font-bold text-primary text-base line-clamp-1">{doc?.title || "Untitled Form"}</h4>
                                ...
                                <div className="aspect-[1.91/1] rounded-xl bg-muted/50 border border-muted/50 flex flex-col items-center justify-center p-6 text-center space-y-3 group-hover:bg-muted/80 transition-colors">
                                    ...
                                    <div className="space-y-1">
                                        <p className="text-[10px] font-bold text-primary uppercase tracking-widest">Better Forms</p>
                                        <p className="text-[9px] text-muted-foreground font-medium">Build forms in minutes, not hours.</p>
                                    </div>
                                </div>
                            </div>
                        </div>
                    ...
                    <div className="space-y-8 pt-10 border-t animate-in fade-in duration-700">
                        <div className="space-y-2">
                            ...
                            <p className="text-sm text-muted-foreground">
                                Use these options to seamlessly embed your form into your website or landing pages.
                            </p>
                        </div>
                        ...
                        <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-8">
                            ...
                            <div className="group cursor-pointer space-y-4">
                                ...
                                <div className="text-center">
                                    <p className="font-bold text-sm group-hover:text-primary transition-colors">Standard</p>
                                    <p className="text-[11px] text-muted-foreground mt-0.5">Embed as a section</p>
                                </div>
                            </div>
                            ...
                            <div className="group cursor-pointer space-y-4">
                                ...
                                <div className="text-center">
                                    <p className="font-bold text-sm group-hover:text-primary transition-colors">Popup</p>
                                    <p className="text-[11px] text-muted-foreground mt-0.5">Show as a popover</p>
                                </div>
                            </div>
                            ...
                            <div className="group cursor-pointer space-y-4">
                                ...
                                <div className="text-center">
                                    <p className="font-bold text-sm group-hover:text-primary transition-colors">Full Page</p>
                                    <p className="text-[11px] text-muted-foreground mt-0.5">Instant landing page</p>
                                </div>
                            </div>
                        </div>
                    </div>
