    ...
    return (
        <div className="flex flex-col h-full bg-background overflow-auto pb-24">
                ...
                <form.AppForm>
                    <form.Form className="p-0 gap-12">
                        ...
                        <Section title="General">
                            ...
                            <SettingItem
                                title={<span>Tally branding <Badge variant="secondary" className="bg-pink-100 text-pink-600 border-none text-[10px] h-4 px-1.5 ml-1">Pro</Badge></span>}
                            ...
                            <SettingItem
                                title={<span>Submissions data retention <Badge variant="secondary" className="bg-blue-100 text-blue-600 border-none text-[10px] h-4 px-1.5 ml-1 uppercase">Business</Badge></span>}
                        ...
                        <Section title="Email notifications">
                            ...
                            <SettingItem
                                title={<span>Respondent email notifications <Badge variant="secondary" className="bg-pink-100 text-pink-600 border-none text-[10px] h-4 px-1.5 ml-1">Pro</Badge></span>}
            ...
            <div className="fixed bottom-0 left-0 right-0 border-t bg-background/80 backdrop-blur-md p-4 flex items-center justify-center gap-6 z-10">
                ...
                <Button variant="link" className="text-muted-foreground hover:text-foreground h-auto p-0 text-sm font-normal">
