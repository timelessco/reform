...
export function VersionHistoryDialog({ formId, open, onOpenChange }: VersionHistoryDialogProps) {
  ...
  const { data: versionContent, isLoading: isLoadingContent } = useFormVersionContent(
